"""
Django settings for localtestapp_1 project.
...
ROOT_URLCONF = 'localtestapp_1.urls'
...
WSGI_APPLICATION = 'localtestapp_1.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "localtestapp_1 API",
    "DESCRIPTION": "API documentation for localtestapp_1 App",
    "VERSION": "v1",
}
